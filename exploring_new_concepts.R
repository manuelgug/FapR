...
a1 <- data.frame(dhps_437 = c("A", "G", "I", "Y"), 
                 freq = c(0.58, 0.32, 0.09, 0.1))
a2 <- data.frame(dhps_540 = c("K", "E", "O"), 
                 freq = c(0.45, 0.37, 0.18))
a3 <-data.frame(dhfr_51_59 = c("IR", "NC", "XY"), 
                 freq = c(0.82, 0.16, 0.02))
a4 <- data.frame(dhfr_108 = c("N", "S"), 
                 freq = c(0.90, 0.1))
