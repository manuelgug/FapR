...
# choose amount of resistance haplos 
n_haplos <- 3
...
observed <- RESULTS_FINAL_multiallelic$HAPLO_FREQ_RECALC
...
# Append RMSE value to vector
rmse_values <- c(rmse_values, rmse)
perc_values <- c(perc_values, perc)

}

beeswarm(rmse_values)
...
ggplot(mapping = aes(x = perc_values, y = perc_values)) +
  geom_beeswarm() +
  labs(title = "Beeswarm Plot of perc_values", x = "Values", y = "Density")
